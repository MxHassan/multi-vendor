      ...
      <div className='w-[300px] '>
        <Card color='transparent' shadow={false} className='h-[calc(100vh-2rem)] w-full p-4'>
          <div className='mb-2 flex justify-between items-center gap-4 p-4'>
            ...
            <IconButton variant='text' color='blue-gray' className='-mr-4' onClick={closeDrawer}>
              <XMarkIcon width={25} />
            </IconButton>
          </div>
          <List>
                    ...
                    categoriesData.map((categorie, index) => {
                      ...
                      return (
                        <Link key={index} to={`/categories/${categorieUrl}`}>
                          <ListItem className='p-0 hover:scale-[1.05] duration-300' key={index} id={categorie.id}>
