...
const TrackOrdersTable = ({ rows }) => {
  const columns = ['Order ID', 'Status', 'Items Qty', 'Total', 'Current Location']
  return (
    <Card className='h-full w-full  '>
      <CardBody className='small-scrollbar 1100px:overflow-hidden overflow-x-scroll px-0 bg-light-background-secondary dark:bg-dark-background-main rounded-md duration-200'>
